...
# Tag Components
for REMOTE in english german greek base http testing parse index mappings query search shared
do
    echo ""
    echo ""
    echo "Releasing $REMOTE";

    TMP_DIR="/tmp/sigmie-split"
    REMOTE_URL="git@github.com:sigmie/$REMOTE.git"
