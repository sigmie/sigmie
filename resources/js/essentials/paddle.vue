<template>
  <a
    href="#!"
    data-theme="none"
    class="paddle_button w-full block text-center rounded-md shadow-sm justify-center py-2 px-4 border border-transparent text-sm font-medium text-white hover:shadow-sm transition-shadow focus:outline-none bg-theme-primary bg-orange-600 focus:bg-orange-700  active:bg-orange-700"
