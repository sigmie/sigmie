...
export const bootstrap = async () => {
  const response = await axios.get('/ajax/routes')

  Vue.prototype.$route = (name, params, absolute) => route(name, params, absolute, response.data)
  ...
  Vue.component('icon-ban', require('./ui/icons/ban').default)
  Vue.component('icon-sun', require('./ui/icons/sun').default)
  Vue.component('icon-document-search', require('./ui/icons/document-search').default)
  ...
  Vue.component('icon-circle-yellow', require('./ui/icons/circle-yellow').default)
  Vue.component('icon-circle-red', require('./ui/icons/circle-red').default)
  Vue.component('icon-external-link', require('./ui/icons/external-link').default)
  Vue.component('icon-loading', require('./ui/icons/loading').default)
  ...
  Vue.component('icon-cheveron-up', require('./ui/icons/cheveron/up').default)
