          ...
          <div class="px-4 py-5 sm:p-0">
            <dl>
              <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-5">
                ...
                <dt class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">Margot Foster</dt>
              </div>
              <div
                class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5"
              >
                <dd class="text-sm leading-5 font-medium text-gray-500">Application for</dd>
                <dt
                  class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2"
                >Backend Developer</dt>
              </div>
              <div
                class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5"
              >
                <dd class="text-sm leading-5 font-medium text-gray-500">Email address</dd>
                <dt
                  class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2"
                >margotfoster@example.com</dt>
              </div>
              <div
                class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5"
              >
                <dd class="text-sm leading-5 font-medium text-gray-500">Salary expectation</dd>
                <dt class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">$120,000</dt>
              </div>
              <div
                class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5"
              >
                <dd class="text-sm leading-5 font-medium text-gray-500">About</dd>
              ...
              <div
                class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5"
              >
                <dd class="text-sm leading-5 font-medium text-gray-500">Attachments</dd>
                <dt class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                  <ul class="border border-gray-200 rounded-md">
                    <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm leading-5">
                      <div class="w-0 flex-1 flex items-center">
                        ...
                        <span class="ml-2 truncate">resume_back_end_developer.pdf</span>
                      </div>
                    ...
                    >
                      <div class="w-0 flex-1 flex items-center">
                        ...
                        <span class="ml-2 truncate">coverletter_back_end_developer.pdf</span>
                      </div>
                      <div class="ml-4 flex-shrink-0">
                        <a
                          href="#"
