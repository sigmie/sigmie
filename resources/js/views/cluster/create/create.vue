  ...
  <app title="Create Cluster">
    ...
    >
      <div class="sm:p-0 px-2 py-1">
        <p class>
          We will create and protect your Elasticsearch cluster with basic auth
          and a free SSL Certificate provided by Cloudflare.
          <br />
            ...
            <div class="col-span-3">
              ...
              >
                <div class="flex align-middle">
                  <icon-info
                    class="flex-none h-8 w-8 text-gray-400 mt-1 mr-3"
                  ></icon-info>
                  <div class="flex-1 text-sm">
                    You can access your Cluster either by using our API with an
                    <a
                      class="text-orange-400"
                      target="_blank"
                      ...
                      >Access Token</a
                    >
                    or directly by using your basic auth credentials.
                  </div>
                </div>
              </dd>
            </div>
