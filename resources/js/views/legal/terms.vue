<template>
  <layout title="Terms of Service">
    ...
    <ul>
      ...
      <li>
        <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Sigmie UG (haftungsbeschränkt), Feldstr. 9, 59507 Lüdenscheid, Germany.
      </li>
      <li>
      ...
      <li>
        <strong>Website</strong> refers to Sigmie Application, accessible from
        <a
          href="https://app.sigmie.com"
        >https://app.sigmie.com</a>
      </li>
      <li>
    ...
    <h3>Payment</h3>
    <p>Fees. Subscriber will pay all fees specified in Service Orders and provide accurate and updated billing contact information. Except as set forth in a Service Order, all fees payable under the Agreement shall be made in U.S. Dollars. Minimum commitments in Service Orders are (a) based on Services purchased and not actual usage; (b) non-cancelable; and (c) cannot be decreased during the specified term. Fees paid for minimum commitments are not refundable. Subscriber’s payments of fees are neither (x) contingent on the delivery of any future functionality or features nor (y) dependent on statements not set forth in the Agreement or any Service Order.</p>

    <p>Invoicing Terms. If the Service Order specifies that payment will occur by a method other than a credit card, Subscriber will provide a purchase order number in the applicable amount (or reasonable alternative proof of Subscriber’s ability to pay the fees specified in a Service Order), and promptly notify Us of any changes necessary for payment of an invoice. We will invoice Subscriber either monthly or according to the billing frequency stated in the Service Order. Invoices to be paid by credit card are due on the invoice date, all other invoices are due net 30 days from the invoice date. If any invoiced amount is not received by Us by the due date, then without limiting Our rights or remedies: (a) those charges may accrue late interest at the rate of 1.5% of the outstanding balance per month, or the maximum rate permitted by law, whichever is lower and (b) We may condition future subscription renewals and Service Orders on shorter payment terms. If Subscriber is paying for Services by credit card, Subscriber will provide Our authorized payment processer with valid credit card information and promptly notify Our authorized payment processor of any changes necessary to charge the credit card. The provision of credit card information to Our authorized payment processer authorizes Us, through its authorized payment processer, to charge the credit card for all Services specified in a Service Order, and any renewal subscription. Subscriber acknowledges that We will not have access to Subscriber’s credit card information.</p>
    <p>Suspension of Service and Acceleration. If any amount owing by Subscriber is 30 or more days overdue (or 15 or more days overdue in the case of invoices to be paid by credit card), We may, without limiting any rights and remedies, accelerate Subscriber’s unpaid fee obligations to become immediately due and payable, and block the provision of Services to Subscriber until the overdue amounts are paid in full. We will give Subscriber at least 10 days’ prior notice that its account is overdue, before blocking Services to Subscriber.</p>
    <p>Payment Disputes. We will not exercise any rights to block Services, accelerate payments, impose late charges or change payment terms with respect to an overdue amount for so long as Subscriber is disputing the overdue amount in good faith. The parties shall cooperate diligently to resolve the dispute.</p>
    <p>Refund or Payment upon Termination. If Subscriber terminates the Agreement, we will refund any prepaid fees covering the remainder of the term of all Service Orders after the effective date of termination. If the Agreement is terminated by Us, the Subscriber will pay any unpaid fees covering the remainder of the term of all Service Orders. In no event will termination relieve Subscriber of its obligation to pay any fees payable for the period prior to the effective date of termination. If Subscriber terminates without cause prior to the end of the then current term, Subscriber shall be immediately liable for the balance of the fees for the remainder of the term.</p>
    <p>Taxes. Fees for Services do not include any taxes, levies, duties, or similar governmental assessments of any nature, including, for example, value-added, sales, use, or withholding taxes assessable by any jurisdiction whatsoever (collectively, “Taxes”). Subscriber is responsible for paying all Taxes associated with its Service Orders. If We are obligated by law to pay or collect Taxes for which Subscriber is responsible, we will invoice Subscriber and Subscriber will pay that amount unless Subscriber can provide a valid tax exemption certificate authorized by the appropriate taxing authority. Subscriber will provide Us any information We reasonably requests to determine whether We are obligated to collect Taxes. We are solely responsible for taxes assessable against its income, property, and employees.</p>
    ...
    <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at support@sigmie.com and include in Your notice a detailed description of the alleged infringement.</p>
    ...
    <ul>
      <li>By email: support@sigmie.com</li>
    </ul>
  </layout>
</template>
