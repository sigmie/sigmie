    ...
    <nav class="container mx-auto">
        <div class="m-0 p-3 row flex h-full m-auto">
            ...
            <div class="col-md-4 col-sm-4 col-xs-4  col-xs-offset-4 col-md-offset-4 flex flex-col justify-center">
                <div class="flex justify-end"> <a class="flex items-center" href="{{ route('login') }}">Sign in
                        <icon-cheveron-right /> </a> </div>
            </div>
        </div>
    </nav>
                ...
                <svg class="mx-auto" width="533px" height="400px" viewBox="0 0 533 575" version="1.1"
                    ...
                    <g id="Homepage" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Desktop-HD" transform="translate(-907.000000, -160.000000)">
                            <rect id="Rectangle" fill="url(#linearGradient-1)" x="0" y="0" width="1440" height="784">
                            </rect>
                        ...
                        <svg class="mx-auto" width="59px" height="60px" viewBox="0 0 59 60" version="1.1"
                            ...
                            <g id="Homepage" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Desktop-HD" transform="translate(-256.000000, -1143.000000)">
                                    ...
                                    <circle id="Oval" stroke="#3C366B" stroke-width="2" cx="289" cy="1169" r="25">
                                    </circle>
                                    <circle id="Oval" fill="#3F3D56" fill-rule="nonzero" cx="281" cy="1178" r="25">
                                    </circle>
                                </g>
                            </g>
                        </svg>
                        ...
                        <svg class="mx-auto" width="54px" height="55px" viewBox="0 0 54 55" version="1.1"
                            ...
                            <g id="Homepage" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Desktop-HD" transform="translate(-716.000000, -1157.000000)">
                                    ...
                                    <g id="Group" transform="translate(716.000000, 1158.000000)" fill-rule="nonzero">
                                        <path
                        ...
                        <svg class="mx-auto" width="61px" height="60px" viewBox="0 0 61 60" version="1.1"
                            ...
                            <g id="Homepage" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Desktop-HD" transform="translate(-1073.000000, -1148.000000)">
                                    ...
                                    <g id="Group-2" transform="translate(1073.000000, 1148.000000)" fill-rule="nonzero">
                                        <circle id="Oval" fill="#3F3D56" cx="30.5048819" cy="29.78906" r="29.78906">
                                        </circle>
                        ...
                        <svg width="450px" height="284px" viewBox="0 0 559 284" version="1.1"
                            ...
                            <g id="Homepage" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Desktop-HD" transform="translate(-89.000000, -2336.000000)">
                                    <rect id="Rectangle" fill="#EBF8FF" x="0" y="2186" width="1440" height="601"></rect>
                                    <g id="undraw_server_down_s4lk" transform="translate(89.000000, 2336.000000)">
                                        <path
                                        ...
                                        <ellipse id="Oval" fill="#3F3D56" fill-rule="nonzero" cx="94" cy="146" rx="94"
                                            ry="13"></ellipse>
                                        <ellipse id="Oval" fill="#000000" fill-rule="nonzero" opacity="0.1" cx="94"
                                            cy="146.5" rx="79" ry="10.5"></ellipse>
                                        <ellipse id="Oval" fill="#3F3D56" fill-rule="nonzero" cx="416.5" cy="264.5"
                                            rx="142.5" ry="19.5"></ellipse>
                                        <path
                                        ...
                                        <circle id="Oval" fill="#F2F2F2" fill-rule="nonzero" cx="416" cy="45" r="2">
                                        </circle>
                                        <path
                                        ...
                                        <path
                                            ...
                                            id="Path" fill="#000000" fill-rule="nonzero" opacity="0.1"></path>
                                        <ellipse id="Oval" fill="#F2F2F2" fill-rule="nonzero" cx="532" cy="262" rx="4"
                                            ry="1"></ellipse>
                                        <circle id="Oval" fill="#F2F2F2" fill-rule="nonzero" cx="415" cy="207" r="6">
                                        </circle>
                                        ...
                                        <rect id="Rectangle" fill="#3F3D56" fill-rule="nonzero" x="39" y="0" width="126"
                                            height="43"></rect>
                                        ...
                                        <rect id="Rectangle" fill="#3F3D56" fill-rule="nonzero" x="39" y="103"
                                            width="126" height="43"></rect>
                                        <rect id="Rectangle" fill="#6C63FF" fill-rule="nonzero" opacity="0.4" x="131"
                                            y="7" width="8" height="8"></rect>
                                        <rect id="Rectangle" fill="#6C63FF" fill-rule="nonzero" opacity="0.8" x="143"
                                            y="7" width="8" height="8"></rect>
                                        <rect id="Rectangle" fill="#6C63FF" fill-rule="nonzero" x="154" y="7" width="8"
                                            height="8"></rect>
                                        <rect id="Rectangle" fill="#6C63FF" fill-rule="nonzero" opacity="0.4" x="131"
                                            y="59" width="8" height="8"></rect>
                                        <rect id="Rectangle" fill="#6C63FF" fill-rule="nonzero" opacity="0.8" x="143"
                                            y="59" width="8" height="8"></rect>
                                        <rect id="Rectangle" fill="#6C63FF" fill-rule="nonzero" x="154" y="59" width="8"
                                            height="8"></rect>
                                        <rect id="Rectangle" fill="#6C63FF" fill-rule="nonzero" opacity="0.4" x="131"
                                            y="109" width="8" height="8"></rect>
                                        <rect id="Rectangle" fill="#6C63FF" fill-rule="nonzero" opacity="0.8" x="143"
                                            y="109" width="8" height="8"></rect>
