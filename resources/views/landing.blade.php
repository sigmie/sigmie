                ...
                <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                    <div class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                        ...
                        <ul class="w-full text-center text-sm">
                            <li class="border-b py-4">15 days free trial</li>
                            <li class="border-b py-4">Alerts- we monitor your clusters and even send you mail
                                notification about anything suspicious.</li>
                            <li class="border-b py-4">3 Node cluster for hight availability.</li>
                            <li class="border-b py-4">Metrics we provide metrics about your Elasticseasrch data and
                                indexes.</li>
                        </ul>
                    </div>
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                        <div class="w-full pt-6 text-3xl text-gray-600 font-bold text-center">$12
                        </div>
