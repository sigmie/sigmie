<section class="bg-white px-10 md:py-20">
    <div class="container mx-auto lg:w-10/12 md:px-4">
        <div class="flex flex-col-reverse md:flex-col">
            <div
                ...
                <div class="flex mx-auto w-2/3 md:mx-0 py-5">
                    <h2 class="font-bold text-gray-800 text-xl md:text-3xl">
                        ...
                        <span class="hidden md:inline-block leading-none text-gray-500 font-normal text-sm">/ per
                            project.</span>
                        <span class="block md:hidden leading-none text-gray-500 font-normal text-sm">per project.</span>
                    </h2>
                </div>
            ...
            <div class="flex-col md:flex-row flex md:space-x-4 justify-between pt-8">
                ...
                <div class="md:w-1/3 md:mx-auto flex-1 mx-0 mt-8 md:mt-0">
                    <ul class="text-black">
                        ...
                        <li class="text-sm leading-5 mb-4 flex">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm h-16">Get notifications regarding significant changes
                                    via Email, Slack and SMS.</p>
                            </div>
                        </li>
                        <li class="text-sm leading-5 mb-4 flex">
                            <div>
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm h-16">Choose your desired Cloud Provider between Google
                                    Cloud, AWS, Digital Ocean and Microsoft Azure.</p>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="md:w-1/3 md:mx-auto flex-1 mx-0 md:mt-0">
                    <ul class="text-black">
                        <li class="text-sm leading-5 mb-4 flex flex-">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm h-16">Make 50.000 requests each month, by using your
                                    access tokens.</p>
                            </div>
                        </li>
                        <li class="text-sm leading-5 mb-4 flex">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm h-16">Query your search, and recieve analysis regarding
                        ...
                        <li class="text-sm leading-5 mb-4 flex">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm h-16">Create a test and staging environment for your
