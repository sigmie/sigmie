...
<div class="w-128 mx-auto">
    <h1 class="text-lg pb-6">
        Privacy Policy for MOS - Sigma s.r.o.
    </h1>

    <p class="pb-4">
        At MOS - Sigma, accessible from https://mos-sigma.com, one of our main priorities is the privacy of our
        visitors.
        This Privacy Policy document contains types of information that is collected and recorded by MOS - Sigma and how
        we use it.
    </p>
    ...
    <p class="pb-2">
        MOS - Sigma s.r.o. legal basis for collecting and using the personal information described in this Privacy
        Policy
        depends on the Personal Information we collect and the specific context in which we collect the information:
    </p>

    <ul class="list-inside">
        <li>MOS - Sigma s.r.o. needs to perform a contract with you</li>
        <li>You have given MOS - Sigma s.r.o. permission to do so</li>
        <li>Processing your personal information is in MOS - Sigma s.r.o. legitimate interests</li>
        <li>MOS - Sigma s.r.o. needs to comply with the law</li>
    </ul>

    <p class="pb-4">
        MOS - Sigma s.r.o. will retain your personal information only for as long as is necessary for the purposes set
        out in this Privacy Policy. We will retain and use your information to the extent necessary to comply with our
    ...
    <p class="pb-4">
        ...
        please contact us. Our Privacy Policy was generated with the help of <a
            href="https://www.gdprprivacypolicy.net/">GDPR Privacy Policy Generator</a> and the <a
            href="https://www.app-privacy-policy.com">App Privacy Policy Generator</a>.</p>
    ...
    <h2 class="">Log Files</h2>

    <p>MOS - Sigma follows a standard procedure of using log files. These files log visitors when they visit websites.
    ...
    <p>Like any other website, MOS - Sigma uses 'cookies'. These cookies are used to store information including
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of MOS - Sigma.</p>

    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on MOS - Sigma, which are sent directly to users' browser.
    ...
    <p>Note that MOS - Sigma has no access to or control over these cookies that are used by third-party advertisers.
    </p>

    <h2>Third Party Privacy Policies</h2>

    <p>MOS - Sigma's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
    ...
    <p>MOS - Sigma does not knowingly collect any Personal Identifiable Information from children under the age of 13.
    ...
    <p>Our Privacy Policy created at GDPRPrivacyPolicy.net) applies only to our online activities and is valid for
        visitors to our website with regards to the information that they shared and/or collect in MOS - Sigma. This
        policy is not applicable to any information collected offline or via channels other than this website. <a
            href="https://gdprprivacypolicy.net">Our GDPR Privacy Policy</a> was generated from the GDPR Privacy Policy
        Generator.</p>
