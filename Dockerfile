...
RUN apt-get update && \
    ...
    apt-get update && \
    apt-get install -y software-properties-common default-mysql-client && \
    apt install apt-transport-https lsb-release ca-certificates wget -y && \
    wget -O /etc/apt/trusted.gpg.d/php.gpg https://packages.sury.org/php/apt.gpg && \
    sh -c 'echo "deb https://packages.sury.org/php/ $(lsb_release -sc) main" > /etc/apt/sources.list.d/php.list' && \
    apt-get update && \
    apt-get install -y php8.0 php8.0-fpm php8.0-zip php8.0-dom php8.0-intl php8.0-mbstring php8.0-simplexml php8.0-xml php8.0-common php8.0-opcache php8.0-cli php8.0-gd php8.0-curl php8.0-mysql  php8.0-bcmath php8.0-redis php8.0-sqlite3 && \
