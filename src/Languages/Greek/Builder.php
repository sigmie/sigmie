...
class Builder extends IndexBuilder implements LanguageBuilder
{
    ...
    public function greekStopwords(?string $name = null): static
    {
    ...
    public function greekLowercase(?string $name = null): static
    {
    ...
    public function greekStemmer(?string $name = null): static
    {
