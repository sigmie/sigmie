...
class Builder extends IndexBuilder implements LanguageBuilder
{
    ...
    public function germanStopwords(?string $name = null): static
    {
    ...
    public function germanNormalize(?string $name = null): static
    {
    ...
    public function germanLowercase(?string $name = null): static
    {
    ...
    public function germanLightStemmer(?string $name = null): static
    {
    ...
    public function germanStemmer(?string $name = null): static
    {
    ...
    public function germanStemmer2(?string $name = null): static
    {
    ...
    public function germanMinimalStemmer(?string $name = null): static
    {
