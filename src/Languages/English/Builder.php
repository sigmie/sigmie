...
class Builder extends IndexBuilder implements LanguageBuilder
{
    ...
    public function englishStopwords(?string $name = null): static
    {
    ...
    public function englishPossessiveStemming(?string $name = null): static
    {
    ...
    public function englishStemmer(?string $name = null): static
    {
    ...
    public function englishPorter2Stemmer(?string $name = null): static
    {
    ...
    public function englishLightStemmer(?string $name = null): static
    {
    ...
    public function englishLovinsStemmer(?string $name = null): static
    {
    ...
    public function englishMinimalStemmer(?string $name = null): static
    {
    ...
    public function englishLowercase(?string $name = null): static
    {
